...
class SerializeTest < MiniTest::Unit::TestCase
  ...
  def setup
    ...
    @region_1 = Region.new([{:x=>900.0, :y=>450.0}, {:x=>800.0, :y=>450.0}], 3, 3, 7)
      ...
      [
        {
          ...
          :race=>[],
          :occupied_regions=>nil,
          :color=>nil
        }
      ],
      :raceboard=>
      [
        {:name=>"golems", :troops_number=>5},
        {:name=>"dragons", :troops_number=>3},
        {:name=>"elves", :troops_number=>6},
        {:name=>"undeads", :troops_number=>6},
        {:name=>"giants", :troops_number=>4},
        {:name=>"centaurs", :troops_number=>7},
        {:name=>"humans", :troops_number=>5},
        {:name=>"orcs", :troops_number=>5},
        {:name=>"dwarves", :troops_number=>6},
        {:name=>"skeletons", :troops_number=>8},
        {:name=>"sorcerers", :troops_number=>5},
        {:name=>"tritons", :troops_number=>8},
        {:name=>"trolls", :troops_number=>5},
        {:name=>"demons", :troops_number=>3}
      ]
    }
    ...
    exp = [
      {
        ...
        coins: 5,
        cardinal_point: "North",
        race: [{:name=>"humans", :troops_number=>5}],
        occupied_regions: [
          {:coordinates=>[{:x=>900.0, :y=>450.0}, {:x=>800.0, :y=>450.0}], :land_type=>{:name=>"forest", :conquest_points=>2, :color=>"yellow"}, :has_tribe=>nil, :id=>7, :player_defense=>nil}
        ],
        color: nil
      }
    ]
    assert_equal exp, @serialize.serialize_players(@players)
  end
